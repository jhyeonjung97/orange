...
for atoms in traj:
    ...
    list = [atoms[65].z,atoms[73].z,atoms[66].z,atoms[75].z,atoms[79].z,atoms[71].z,atoms[89].z,atoms[63].z,
            atoms[68].z,atoms[78].z,atoms[70].z,atoms[83].z,atoms[82].z,atoms[72].z,atoms[90].z,atoms[69].z,
            atoms[64].z,atoms[67].z]
