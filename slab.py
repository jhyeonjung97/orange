...
parser.add_argument('-o', '--output',type=str, default='slab', help='output filename')
...
parser.add_argument('-r', '--repeat', type=str, default='2,2,3', help='Repeat unit cell (e.g., "a,b,c")')
...
while i <= numb:
    ...
    slab=surface(bulk, (x,y,z), c, vacuum/2).repeat((a,b,1))
